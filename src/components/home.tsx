    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-[#1a1a1a] text-[#1a1a1a] flex h-screen items-center justify-center flex-col gap-2">
                <div className="flex absolute flex-col max-w-[300px] sm:max-w-[400px] md:max-w-[500px] h-[350px] items-center justify-center shadow-2xl bg-[hsl(104,12%,83%)] dark:bg-[#809679] text-black rounded-lg">             
