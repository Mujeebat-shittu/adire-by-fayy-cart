            ...
            <main className="bg-white dark:bg-black text-black flex min-h-screen items-center justify-center flex-col gap-2 my-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 place-content-center gap-y-8 gap-x-6 mx-auto my-10 space-y-4 space-x-4 ">
                    {filteredProducts?.map((product) => (
                        <Card key={product.id}
                            className="max-w-[350px] md:w-[260px] lg:w-[300px] bg-[#d1d9ce] dark:bg-[#809679] dark:text-[#1a1a1a] py-6 px-8 flex flex-col text-left hover:scale-[1.07] hover:translate-y-3 cursor-pointer ring-2 ring-[#d0d8cd]/50 hover:ring-[#d0d8cd]/80 transition-all duration-300"
                        >
