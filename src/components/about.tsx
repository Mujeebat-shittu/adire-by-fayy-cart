...
function About() {
    return (
        ...
        <div className="overflow-hidden">
            <Header />
            <div className="bg-linear-to-r from-white to-[#d1d9ce] dark:bg-linear-to-r dark:from-[#1a1a1a] dark:to-[#809679] text-black flex min-h-screen items-center justify-center flex-col gap-2">
