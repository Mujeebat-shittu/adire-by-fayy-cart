    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-[#1a1a1a] text-black flex h-screen items-center justify-center flex-col gap-2">
                <div className="flex absolute flex-col max-w-[300px] sm:max-w-[400px] md:max-w-[500px] max-h-[400px] overflow-hidden sm:h-[400px] items-center justify-center shadow-2xl bg-[#d0d8cd] dark:bg-[#809679] text-[#1a1a1a] rounded-lg">             
